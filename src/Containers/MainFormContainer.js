...
class MainFormContainer extends Component {
    ...
    loadData = async () => {
        ...
        try {
            ...
            newState.oldData = newState.oldData.reverse();
            if (newState.oldData.length > 5) {
                newState.oldData = newState.oldData.slice(0, 5)
            }
            ...
            if (error instanceof SyntaxError) {
                ...
                this.setState({
                    isLoading: false, error: {
                        "message": "API's requests limit has been reached. Please, try again later."
                    }
                })
            } else {
                ...
                this.setState({
                    isLoading: false, error: {
                        "message": "Try to check your network status or disable ad-blocker."
                    }
                })
            }
        }
